...
import com.xuan.erp.utils.StringUtil;
...
public class DatabaseSchema {
     ...
     * @throws SQLException 
     */ 	
	public List<ColumnProperty> getTableColumns(String tableName) throws SQLException {		
        ...
        while(rs.next()) {
        	...
        	// 字段名转成规范命名
        	column.javaName = StringUtil.toCamelCase(column.name);
